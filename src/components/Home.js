  ...
  const fetchProducts = () => {
    ...
    let products = [
      ...
      },
      {
        ...
        was: 35,
        weight: "1 kg",
        pic: "https://5.imimg.com/data5/SELLER/Default/2022/4/EQ/MK/KW/142330742/maharashtra-pink-onion-500x500.jpg",
        popular: 1,
        type: "vegetables",
      },
      {
      ...
      },
      {
        ...
        was: 12,
        weight: "100 gm",
        pic: "https://media.istockphoto.com/id/1092706786/photo/ginger-root-slices-isolated-on-white-background.jpg?s=2048x2048&w=is&k=20&c=fd2gVfLjLYWoexnJ0li9UbGU8JA2YXzfX8CvfA_rV_U=",
        popular: 1,
        type: "vegetables",
      },
      {
